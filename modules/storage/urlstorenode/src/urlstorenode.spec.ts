import { NamedUrl, namedUrlToPathAndDetails, nameSpaceDetails, nameSpaceDetailsForGit, OrganisationUrlStoreConfigForGit, parseNamedUrlOrThrow } from "@itsmworkbench/url";
