...
import { ApprovalState, defaultKnowledgeArticleDetails, KnowledgeArticleDetails,TicketTypeName } from "@itsmworkbench/knowledgearticle";

export interface SelectTicketTypeProps<S> extends LensProps<S, KnowledgeArticleDetails, any> {
  readonly? : boolean
}
