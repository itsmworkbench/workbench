...
export interface DisplaySelectKnowledgeArticleWorkbenchProps<S> extends LensProps2<S, Action, IdAnd<KnowledgeArticle>, any> {
  targetPath: string
...
export function DisplaySelectKnowledgeArticleWorkbench<S> ( { state, targetPath, processSe }: DisplaySelectKnowledgeArticleWorkbenchProps<S> ) {
  ...
  const ticketType: KnowledgeArticle = action.ticketType || {}
