...
export const displayReviewTicketWorkbench = <S, State> (): ActionPlugIn<S, State, DisplayReviewTicketWorkbenchProps<S>> =>
  ( props: ( s: LensState<S, State, any> ) => DisplayReviewTicketWorkbenchProps<S> ): ActionPluginDetails<S, State, DisplayReviewTicketWorkbenchProps<S>> => ({
