import { isBadIdStoreResult } from "@itsmworkbench/idstore";
import { SubCommandDetails } from "@itsmworkbench/cli";
import { idStore } from "./id.store.cli";
import { defaultVariablesExtractor } from "@itsmworkbench/defaultdomains";
import { extractVariablesFrom } from "@itsmworkbench/variables";
