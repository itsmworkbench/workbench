...
export function GuiNav<S> ( { state }: LensProps<S, ItsmState, any> ) {
  ...
  >
    ...
    {showDevMode && <>
        <FocusOnSetValueButton aria-label='Experimental New Wizard' startIcon={<SettingsIcon/>} valueToSet={{ workspaceTab: 'experimentalNewTicketWizard' }} state={tabsState} sx={buttonSx}>Experimental New Wizard</FocusOnSetValueButton>
