...
export function DisplayLdapWorkbench<S>({state, processSe}: DisplayLdapWorkbenchProps<S>) {
    ...
    return <Container maxWidth="md">
        ...
        <Box marginBottom={2}>
            ...
            <SuccessFailureButton processSe={processSe(actionState)} title='The LDAP details are good' successOrFail={true} context={contextFn}/>
            <SuccessFailureButton processSe={processSe(actionState)} title='The LDAP details show a problem' successOrFail={false} context={contextFn}/>
        </Box>
    </Container>
}
