...
import {makeContextFor, makeRoutingSegmentContextFor} from "@itsmworkbench/react_utils";
...
export const {use: useSelectedSovereign, Provider: SovereignStateProvider} = makeRoutingSegmentContextFor('routing0', 0, true)
