...
export type TwoColumnAndRestLayout = (props: TwoColumnAndRestLayoutProps) => React.ReactElement;
export const SimpleTwoColumnAndRestLayout:TwoColumnAndRestLayout = ({ rootId, children }) => {
