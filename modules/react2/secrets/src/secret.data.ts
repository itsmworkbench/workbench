...
export function hasPassword(s: SecretDataWithoutPasswordChecked): s is SecretData {
    return !!s.testValue
}

export function hasEnteredPassword(s: SecretDataWithoutPasswordChecked): boolean {
